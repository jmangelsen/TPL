...
const BriefingCard = ({ title, date, category, icon: Icon, summary }: any) => (
  <div className="p-8 bg-[#0f1a24] border border-white/10 hover:border-white/30 transition-colors flex flex-col gap-4 group cursor-pointer">
    <div className="flex items-center justify-between mb-2">
      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">{category}</span>
      <span className="text-xs font-mono text-slate-300">{date}</span>
    </div>
    <div className="flex items-start gap-4">
      <div className="w-10 h-10 bg-[#1a2633] border border-white/20/5 flex items-center justify-center shrink-0 text-white">
        <Icon size={18} />
      </div>
      <div>
...
export const IntelligenceArchive = () => {
  return (
    <div className="min-h-screen bg-[#1a2633] py-24 px-6 relative overflow-hidden">
      {/* Background Seal */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-20 text-center">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-serif italic">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-6">
            <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-6 border-b border-white/10 pb-4">Latest Briefings</h2>
            <BriefingCard 
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-6 border-b border-white/10 pb-4">Data Trackers</h2>
